...
function Leetcode(url,username){
    let output = '';
    fetch(url)
    .then((response)=>{
...
function CodeForces(url){
    ...
    .then((data)=>{
        ...
        <div class="container p-5 table-responsive">
            ...
            <table class="table text-center table-sm table-bordered border-dark table-hover">
...
function SPOJ(url,username){
    ...
    .then((data)=>{
        ...
        <section class="p-5 mt-3">
        <h3 class="text-center mb-3">Welcome ${data.username} !!!</h3>
            <div class="container mb-5" style="width:500px; height:300px">
                <div class="row text-center g-4">
                    <div class="col-md">
                        <div class="card bg-dark text-light">
                            <div class="card-body text-center">
                                ...
                                <p class="card-text">
                                    <li class="list-group-item bg-dark text-light">Username: ${data.username}</li>
                                    <li class="list-group-item bg-dark text-light">Current Rank: ${data.points}</li>
                                    <li class="list-group-item bg-dark text-light">Best Rank: ${data.rank}</li>
                                    <li class="list-group-item bg-dark text-light">Best Rank: ${data["join data"]}</li>
                                    <li class="list-group-item bg-dark text-light">Best Rank: ${data.institute}</li>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        tbl+=`
            ...
            <h3 class="text-center mb-3"> Problems Solved</h3>
                <table class="table bg-light text-center table-sm table-bordered border-dark table-hover">
                    <thead class="thead-dark">
                    <tr>
                        <th scope="col">S No.</th>
